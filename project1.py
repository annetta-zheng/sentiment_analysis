...
def perceptron_single_step_update(
    ...
    """
    # Your code here
    if label * (np.dot(current_theta, feature_vector.transpose()) + current_theta_0) <= 0:
    ...
    for i, text in enumerate(reviews):
        ...
        for word in word_list:
            ...
            if word in dictionary:
                feature_matrix[i, dictionary[word]] = n
